...
*/
var uri = "mongodb://mongo:27017/kennel";
...
app.get('/', function(req, res){
	var myobj = {Last_Name: "Kulkarni", First_Name: "Aditya", Email: "adityak15@kpit.com", contact: "9130351967", Organization: 'Kpit', Password: "123456" };
        connection.collection("Admin").insertOne(myobj, function(err, res) {
                if (err) throw err;
...
app.get('/Configuration_Management',function(req, res, next){
	...
	connection.collection('Configuration_Management').find({},function(err, docs){
		if(err) throw err;
		console.log(docs);
		res.render('Configuration_Management_Exam',{items: docs});
	});
	/*
...
app.post('/SignUp', function(req, res, next) {
	...
	var myobj = {Last_Name: lname, First_Name: fname, Email: Ename, contact: contact, Organization: Oname, Password: password };
	connection.collection("User").insertOne(myobj, function(err, res) {
		if (err) throw err;
    		console.log("1 document inserted");
	})
	res.redirect('/Login');
...
app.post('/Login', function(req, res, next) {
	...
	connection.collection("User").find(query).toArray(function(err, result){
		if (err) throw err;  
...
app.post('/ADLogin', function(req, res, next) {
	...
	var query = { Email: Email, Password: password };
        connection.collection("Admin").find(query).toArray(function(err, result){
                if (err) throw err;
...
app.post('/ci', function(req, res, next) {
     ...
     var oD = req.body.D;
     var oE = req.body.E;
	var myobj = {Rank: rank,  Question: lname, A: oA, B: oB, C: oC, D: oD, E: oE};
        connection.collection("Continuous_Integration").insertOne(myobj, function(err, res) {
                if (err) throw err;
                console.log("1 document inserted");
        })
...
app.post('/configurationM', function(req, res, next) {
	...
	var myobj = {Rank: rank, Question: qname, A: oA, B: oB, C: oC, D: oD, E: oE};
        connection.collection("Configuration_Management").insertOne(myobj, function(err, res) {
                if (err) throw err;
                console.log("Configuration_Management document inserted");
        })
...
app.post('/IaaS', function(req, res, next) {
	...
	var myobj = {Rank: rank, Question: lname, A: oA, B: oB, C: oC, D: oD, E: oE};
        connection.collection("IaaS").insertOne(myobj, function(err, res) {
                if (err) throw err;
                console.log("1 document inserted");
        })
...
app.post('/AMT', function(req, res, next) {
	...
	var myobj = {Rank: rank, Question: lname, A: oA, B: oB, C: oC, D: oD, E: oE};
        connection.collection("Automation_Testing").insertOne(myobj, function(err, res) {
                if (err) throw err;
                console.log("1 document inserted");
        })
...
app.post('/continuousD', function(req, res, next) {
	...
	var myobj = {Rank: rank, Question: lname, A: oA, B: oB, C: oC, D: oD, E: oE};
        connection.collection("Continuous_Delevery").insertOne(myobj, function(err, res) {
                if (err) throw err;
                console.log("1 document inserted");
        })
...
app.post('/cdeploy', function(req, res, next) {
	...
	var myobj = {Rank: rank, Question: lname, A: oA, B: oB, C: oC, D: oD, E: oE};
        connection.collection("Continuous_Deployment").insertOne(myobj, function(err, res) {
                if (err) throw err;
                console.log("1 document inserted");
        })
...
app.post('/cmonitor', function(req, res, next) {
	...
	var myobj = {Rank: rank, Question: lname, A: oA, B: oB, C: oC, D: oD, E: oE};
        connection.collection("Continuous_Monitor").insertOne(myobj, function(err, res) {
                if (err) throw err;
                console.log("1 document inserted");
        })
